...
class AgentDefaults(Base):
    ...
    # Model routing (all optional — disabled when routing_enabled=False)
    routing_enabled: bool = False
    model_fast: str | None = None    # e.g. "anthropic/claude-haiku-4-5"
    model_normal: str | None = None  # e.g. "anthropic/claude-sonnet-4-5"
    model_heavy: str | None = None   # e.g. "anthropic/claude-opus-4-5"
